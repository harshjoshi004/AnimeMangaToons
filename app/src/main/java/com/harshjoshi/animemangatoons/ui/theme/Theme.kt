package com.harshjoshi.animemangatoons.ui.theme
...
private val LightColorScheme = lightColorScheme(
    ...
    */
    background = Color(0xFFFFEBEE), // Very Light Red/Pink background
    surface = Color(0xFFFFEBEE), // Very Light Red/Pink surface
